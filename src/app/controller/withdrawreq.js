...
module.exports = {
  ...
  createWithdrawreq: async (req, res) => {
    try {
      ...
      // Limit: Only one withdrawal request per 7 days
  ...
  createWithdrawreqByAdmin: async (req, res) => {
    try {
      ...
      return response.ok(res, {
        message: "Withdrawal request created successfully by admin.",
        data: savedRequest,
      });
    } catch (error) {
